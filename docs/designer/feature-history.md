...
- (2026-05-27) v2 · ia-3tab · shipped · note: BottomTab 2→3슬롯 (지도/피드/설정) + Compass SVG + /feed 신규 라우트 SSR (T-IA-01·02)
- (2026-05-27) v2 · feed-sort · shipped · note: FeedSortToggle 4-mode (인기/최신/팔로잉/내지역) + URL ?sort= sync + LoginModal 트리거 (T-IA-03)
- (2026-05-27) v2 · feed-paging · shipped · note: 무한 스크롤 IntersectionObserver + cursor pagination + race guard (T-IA-04)
- (2026-05-27) v2 · feed-following · shipped · note: bookmarks!inner 조인 — 찜한 사람의 공개 코스 노출 (T-IA-05)
- (2026-05-27) v2 · feed-region-impl · scope-change · note: OQ-1 Option A (역지오코딩 행정동 string match) → dev override: getRegionByCoord (drive region exact match against region_tags). 코드베이스 기존 lib 활용 (T-IA-05)
