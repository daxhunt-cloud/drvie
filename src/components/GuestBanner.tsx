...
export default function GuestBanner({ courseId }: GuestBannerProps) {
  ...
  return (
    <div className="guest-banner" style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 50, background: "#222222", padding: "16px 20px", paddingBottom: "calc(16px + env(safe-area-inset-bottom, 0px))", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
      <div>
